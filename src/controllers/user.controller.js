...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  const chanal = await User.aggregate([
    {
      $match: {
        username: username?.toLowerCase(),
      },
...
const getWatchHistory = asyncHandler(async (req, res) => {
  const user = await User.aggregate([
    {
      //  ahi aapne direct user match karaviye chiye to aggegate is freamwork to tene req.user._id ma khabar
      //  padti nathi te mare aane new mongoose.Types.ObjectId this line use karye chiye
      $match: {
